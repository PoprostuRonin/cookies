...
document.addEventListener("DOMContentLoaded", function() {
  ...
  var containerStyle = 'font-size: 13px; z-index: 1000; width: 100%; overflow: hidden; box-sizing: border-box; padding: 5px 10px; opacity: 0.8; position: fixed; bottom: 0; left: 0; background-color: #000; color: #FFF;'
